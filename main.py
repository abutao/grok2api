...
from app.api.v1.video_async import router as video_async_router  # noqa: E402
from app.api.v1.image_async import router as image_async_router  # noqa: E402
...
def create_app() -> FastAPI:
    ...
    app.include_router(
        image_async_router, prefix="/v1", dependencies=[Depends(verify_api_key)]
    )
    app.include_router(
        video_async_router, prefix="/v1", dependencies=[Depends(verify_api_key)]
    )
    app.include_router(
