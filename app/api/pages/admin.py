...
async def admin_tasks():
    return FileResponse(STATIC_DIR / "admin/pages/tasks.html")


@router.get("/admin/text", include_in_schema=False)
async def admin_text():
    return FileResponse(STATIC_DIR / "admin/pages/text.html")
